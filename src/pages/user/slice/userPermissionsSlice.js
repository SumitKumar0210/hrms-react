...
export const fetchUserPermissions = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await api.get("/user-permissions/get-data");
...
export const getDataByModule = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await api.post("/user-permissions/get-data-by-module");
...
export const getModulePermission = createAsyncThunk(
  ...
  async (values, { rejectWithValue }) => {
    console.log(values);
    try {
      const response = await api.post("/user-permissions/get-module-permission", {id:values});
      return response.data.data;
    } catch (error) {
      return rejectWithValue(getErrorMessage(error));
    }
...
export const createUserPermission = createAsyncThunk(
  ...
  async (permissionData, { rejectWithValue }) => {
    try {
      const response = await api.post("/user-permissions/store", permissionData);
...
export const updateUserPermission = createAsyncThunk(
  ...
  async ({ id, data }, { rejectWithValue }) => {
    try {
      const response = await api.put(`/user-permissions/update/${id}`, data);
